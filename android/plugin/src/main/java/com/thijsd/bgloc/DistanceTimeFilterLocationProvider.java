...
public class DistanceTimeFilterLocationProvider extends AbstractLocationProvider implements LocationListener {
    private static final String TAG = DistanceTimeFilterLocationProvider.class.getSimpleName();
    ...
    public DistanceTimeFilterLocationProvider(LocationService context) {
        super(context);
        PROVIDER_ID = 0;
    }
